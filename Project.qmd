...
ed_percent_rec <- recipe(percent_broadband ~ .,
                         data = data_train1) %>%
  step_normalize(percent_broadband, less_than_hs_percent)
...
predictions <- predict(ed_fit, new_data = data_test1)

predictions <- bind_cols(
  data_test,
  predict(object = ed_fit, new_data = data_test1, type = "prob")
  )
